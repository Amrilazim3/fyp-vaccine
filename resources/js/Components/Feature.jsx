export default function Feature() {
    return (
        <div className="pb-16" style={{ fontFamily: '"Lato", sans-serif' }}>
            <section className="max-w-8xl mx-auto container bg-white py-16">
                <div>
                    <div
                        role="contentinfo"
                    ...
                    >
                        ...
                        >
                            You Can Start Tracking Your Child Vaccination!
                        </hh1>
                    </div>
                    <div
                        tabIndex={0}
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="w-10/12">
                                ...
                                >
                                    It provides a very simple start, no need to
                                    write a lot of code, you just import it and
                                    start the primitive components and create
                                    the ones you need.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="w-10/12">
                                ...
                                <p
                                    ...
                                    className="focus:outline-none text-base text-gray-600 leading-normal pt-2"
                                >
                                    Modify the visual appearance of your site –
                                    including colors, fonts, margins and other
                                    style-related properties – with a
                                    sophisticated style.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="w-10/12">
                                ...
                                <p
                                    ...
                                    className="focus:outline-none text-base text-gray-600 leading-normal pt-2"
                                >
                                    Instead of just giving you the tools to
                                    create your own site, they offer you a list
                                    of themes you can choose from. Thus a handy
                                    product.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="w-10/12">
                                <h2
                                    ...
                                    className="focus:outline-none text-lg font-semibold leading-tight text-gray-800"
                                >
                                    Get notify for every date!
                                </h2>
                                <p
                                    tabIndex={0}
                                    className="focus:outline-none text-base text-gray-600 leading-normal pt-2"
                                >
                                    We have chosen the bright color palettes
                                    that arouse the only positive emotions. The
                                    kit that simply assures to be loved by
                                    everyone.
                                </p>
                            </div>
                        </div>
